...
public class LiliHomeCareActivity extends Activity implements TaskObsorver, OnSharedPreferenceChangeListener {
	...
	private static final String TAG = LiliHomeCareActivity.class.getName();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lili_home_care, menu);
		return true;
	}
